...
namespace CSVWriter.Writer
{
    public class CsvWriter<T> : ICsvWriter<T>
    {
        ...
        private static List<IDictionary<string, object>> _csvData = new List<IDictionary<string, object>>();
        private static CsvDelimetterType _delimetterType;
        
        public CsvWriter(CsvDelimetterType delimetterType)
        {
            _delimetterType = delimetterType;
            WriteHeaders();
        }
        ...
        private static void WriteHeaders()
        {
            ...
            modelProperties.ForEach(x =>
            {
                var columnAttribute = (CsvColumnAttribute)x.GetCustomAttribute(typeof(CsvColumnAttribute), false);
